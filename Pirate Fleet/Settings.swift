...
struct Settings {
    ...
    struct Messages {
        ...
        static let HumanHitMine = "Damn, that was a mine..."
        static let ComputerHitMine = "Hahaha! The computer hit a Mine!"
        static let HumanHitMonster = "Now you've done it.... The pissed off Kraken destroys one of your ships..."
        static let ComputerHitMonster = "HaHa, The computer pissed off the Kraken so it destroys one of it's ships!"
